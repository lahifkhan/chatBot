...
class ChatbotGUI:
    ...
    def setup_chatbot_data(self):
        ...
        self.responses = {
            ...
            "name": ["I'm your friendly ChatBot! 🤖", "You can call me ChatBot! I'm here to help! 🤖"],
    ...
    def add_bot_message(self, message):
        ...
        def show_response():
            ...
            self.chat_display.insert(tk.END, f"{timestamp}\n", "time")
            self.chat_display.insert(tk.END, "ChatBot: \n", "sender")
    ...
    def show_typing_indicator(self):
        ...
        self.chat_display.insert(tk.END, "ChatBot is typing...", "sender")
        self.chat_display.see(tk.END)
        self.chat_display.config(state="disabled")
    ...
    def create_header(self):
        ...
        header_label = Label(header_frame, text="CHATBOT", fg="white",
